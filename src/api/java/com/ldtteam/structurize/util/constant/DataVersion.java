...
public enum DataVersion
{
     ...
     */
    UPCOMING(2231, null, null),
    v1_15_2(2230, "1.15.2", UPCOMING),
    ...
    public static final DataVersion CURRENT = findFromDataVersion(SharedConstants.getVersion().getWorldVersion());
